 ...
 * preço de um carro novo para os clientes. Você receberá o custo de fábrica e
 * as porcentagens referentes ao distribuidor e os impostos e deverá escrever
 * programa para ler esses valores e imprimir o valor final do carro.
 * Entrada
 * Você recebera três valores inteiros que representam o
 * custo de fábrica, as porcentagens do distribuidor e os impostos.
 * Saída
